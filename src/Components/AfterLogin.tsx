    ...
    return (
        <section className='w-full h-screen flex justify-start items-center flex-col overflow-x-hidden'>
            ...
            <div className="w-full h-full mt-8">
                {show &&
                    <Fade triggerOnce>
                        <Popup status={show} setShow={setShow} updatedUser={handleAdminRegistration}/>
                    </Fade>
                }
                {/*{!show ? null : null*/}
                {/*}*/}
                <div className='w-full h-60vh relative'>
                    <img src={pic4} alt="background-image" className="absolute w-full inset-0 2xl:h-full xl:h-full lg:h-full md:h-full sm:h-full xs:h-full xx:h-[60%] object-cover" />
