        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
              ...
              />
              <h3 className="text-xl font-kanit font-bold text-bluerry mb-2">
                SRC Elections
              </h3>
              <p className="text-gray-600 font-kanit">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-gray-600 font-kanit italic mb-4">
              "eBallot transformed our election process, making it more
          ...
          <div className="bg-white p-8 rounded-lg shadow-md">
            <p className="text-gray-600 font-kanit italic mb-4">
              "The security features gave us peace of mind, and the real-time
