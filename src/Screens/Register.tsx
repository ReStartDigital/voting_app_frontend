          ...
          {elections.map((election) => (
            ...
            >
              ...
              <CardContent className="p-6">
                ...
                <Button
                  className="mt-4 w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-kanit py-2 rounded-lg transition-all duration-200"
                  onClick={() =>
                    handleClick(
                      election.id,
